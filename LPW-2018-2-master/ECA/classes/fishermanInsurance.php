...
class fishermanInsurance
{
     ...
     */
    public function __construct($id_fisherman_insurance, $str_month, $str_year, $db_value, $tb_beneficiaries_id_beneficiaries, $tb_city_id_city)
    {
    ...
    /**
     * @param mixed $id_fisherman_insurance
     */
